...
Spin up the provided Docker Compose instance and add `http://<local-server-ip>:3010/opds` to your OPDS reader.
...
| ABS_API_TOKEN    | Your Audiobookshelf API token.                                              |                       | Yes      |
